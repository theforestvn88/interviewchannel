...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference("Interview.count") do
      post interviews_url, params: { interview: { code: @interview.code, end_time: @interview.end_time, note: @interview.note, result: @interview.result, start_time: @interview.start_time } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { code: @interview.code, end_time: @interview.end_time, note: @interview.note, result: @interview.result, start_time: @interview.start_time } }
